        ...
        <div className="max-w-7xl mx-auto px-6 py-6">
          <nav className="flex justify-between items-center">
            <div className="flex items-center gap-3">
              <div className="w-10 h-10 bg-gradient-to-br from-[#ceff66] to-[#a8d651] rounded-lg flex items-center justify-center">
                <svg className="w-6 h-6 text-[#0f0c09]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
